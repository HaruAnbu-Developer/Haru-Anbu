...
class DailyQuestion(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    content = Column(Text, nullable=False) # "첫 월급으로 무엇을 하셨나요?"
    target_date = Column(String(10), nullable=False, unique=True) # "2024-01-14" (Java LocalDate 매핑)
    topic_id = Column(String(50)) # "FIRST_SALARY"
    created_at = Column(DateTime, default=func.now())
